$('.card').on('click', function () {
    ...
    if (topic === 'Usage') {
        ...
        $('#column-right').append('<p id="additional-text">Make <a id="borscht-link" href="#">borscht</a>.<br>Or roast them.<br>Avoid beet hummus.</p>');
        ...
        // Toggle visibility of recipe container when clicking on "Borscht" link
        $('#borscht-link').click(function (event) {
